...
const accentMap: Record<string, {
    ...
    amber: {
        ...
        icon: "bg-amber-50 dark:bg-amber-500/10 border-amber-200 dark:border-amber-500/20 text-amber-500 dark:text-amber-400",
        ring: "hover:border-amber-300 dark:hover:border-amber-500/30",
        dot: "bg-amber-400",
        bar: "bg-amber-400",
    },
    emerald: {
        ...
        icon: "bg-emerald-50 dark:bg-emerald-500/10 border-emerald-200 dark:border-emerald-500/20 text-emerald-500 dark:text-emerald-400",
    ...
    blue: {
        ...
        icon: "bg-blue-50 dark:bg-blue-500/10 border-blue-200 dark:border-blue-500/20 text-blue-500 dark:text-blue-400",
    ...
    violet: {
        ...
        icon: "bg-violet-50 dark:bg-violet-500/10 border-violet-200 dark:border-violet-500/20 text-violet-500 dark:text-violet-400",
        ring: "hover:border-violet-300 dark:hover:border-violet-500/30",
        dot: "bg-violet-400",
        bar: "bg-violet-400",
    },
    rose: {
        badge: "bg-rose-50 dark:bg-rose-500/10 text-rose-600 dark:text-rose-400 border-rose-200 dark:border-rose-500/20",
        icon: "bg-rose-50 dark:bg-rose-500/10 border-rose-200 dark:border-rose-500/20 text-rose-500 dark:text-rose-400",
        ring: "hover:border-rose-300 dark:hover:border-rose-500/30",
        dot: "bg-rose-400",
        bar: "bg-rose-400",
    },
    sky: {
        badge: "bg-sky-50 dark:bg-sky-500/10 text-sky-600 dark:text-sky-400 border-sky-200 dark:border-sky-500/20",
        icon: "bg-sky-50 dark:bg-sky-500/10 border-sky-200 dark:border-sky-500/20 text-sky-500 dark:text-sky-400",
        ring: "hover:border-sky-300 dark:hover:border-sky-500/30",
        dot: "bg-sky-400",
        bar: "bg-sky-400",
    },
}
